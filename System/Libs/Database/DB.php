...
class DB
{
    ...
    public function where($where, $val = null, $op = '=', $type = '', $andOr = "AND")
    {
        if (is_array($where)) {
            $_where = [];
    ...
    public function orWhere($where,  $val = null,$op = '=')
    {
    ...
    public function notWhere($where,  $val = null,$op = '=')
    {
    ...
    public function orNotWhere($where,  $val = null,$op = '=')
    {
